                ...
                <div className="mainContent">
                    <div className="textIntroduction">
                        <div className="introTextContainer">
                            <h1 className="introText">Welcome to the</h1>
